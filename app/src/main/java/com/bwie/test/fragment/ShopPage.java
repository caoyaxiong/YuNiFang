...
import com.bwie.test.adapter.ShopcartExpandableListViewAdapter;
import com.bwie.test.bean.GroupInfo;
import com.bwie.test.bean.ProductInfo;
import com.bwie.test.database.ShangPing;
import com.bwie.test.database.SqLiteDao;
import com.bwie.test.utils.ImageLoaderUtils;
...
public class ShopPage extends Fragment implements ShopcartExpandableListViewAdapter.CheckInterface, ShopcartExpandableListViewAdapter.ModifyCountInterface, View.OnClickListener {
    ...
    public void onClick(View v)
    {
        ...
        switch (v.getId())
        {
            case R.id.all_chekbox://全选 或者 反选
                doCheckAll();
                break;
